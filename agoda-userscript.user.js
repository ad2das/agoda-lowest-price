...
(function () {
  ...
  const DEFAULTS = {
    ...
    promoList: [
      ...
      'AGDNEW7', 'DISPOT2026', 'AGDBENE5', 'AGODASPONSORED',
      'AGODADEAL8', 'LP10AGD1', 'LP12AGD1', 'AGODAKR10',
      'AGODAJANNY', 'RICHIEGOTYOU', 'CHARMAGODA', 'HENDRIXSTAY',
      'KAAGODA', 'GERAEMON5', 'AJSOMEAGODA', 'IRENELB15',
      'TZNTRAVEL', 'JAMIMOYVLOGS5', 'TANSACTIVITY', 'CKAGODATIX',
      'TZNACTIVITY', 'AL5',
      'AGSALE23', 'AGSALE2023', 'GAGAGO', 'SUZELLAGODA',
      'AGODALOURIZ8', 'AGODAGUNG', 'AGODASBSTAY', 'AGODAJILL',
      'AGODALOVES', 'REMOTETRAVEL', 'ARIANEVACAY', 'AGODATPT',
      'AATPT', 'MKKTHAILAND', 'RODIANEAGODA', 'AGRJKPW8',
      'P678292', 'VISA25', 'CM24', 'PRINCESSLOVE'
    ],
